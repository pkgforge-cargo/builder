 ...
 #Set Build Flags
  cross_build()
  {
   #Env  
    ...
    #Set Min stack size (32 MB): https://github.com/rust-lang/rust/issues/126897
...
##Main
  ...
  #Gen Metadata
   ...
   for PROG in "${PROGS[@]}"; do
    ...
    #Description 
     PKG_DESCRIPTION="$(jq -r '.description | split(".")[0] + "." | gsub("`"; "")' "${CRATE_META}" 2>/dev/null | grep -iv 'null' | sed 's/`//g' | sed 's/^[ \t]*//;s/[ \t]*$//' | sed ':a;N;$!ba;s/\r\n//g; s/\n//g' | sed 's/["'\'']//g' | sed 's/|//g' | sed 's/`//g')"
