...
- 🦀 **[loctok](https://github.com/zxch3n/loctoc)**: Count LOC (lines of code) & TOK (LLM tokens), fast.
...
- 🦀 **[drstr](https://github.com/iksuddle/drstr)**: A simple library for parsing human-readable duration strings into `std::time::Duration`.
