...
- 🦀 **[metarepo-core](https://github.com/codyaverett/gestalt)**: Core interfaces and types for the metarepo multi-project management tool.
- 🦀 **[metarepo-project](https://github.com/codyaverett/gestalt)**: Project creation and import for the metarepo multi-project management tool.
- 🦀 **[metarepo-exec](https://github.com/codyaverett/gestalt)**: Execute commands across multiple repositories for the metarepo project management tool.
- 🦀 **[metarepo-git](https://github.com/codyaverett/gestalt)**: Git operations across multiple repositories for the metarepo project management tool.
- 🦀 **[metarepo-init](https://github.com/codyaverett/gestalt)**: Initialize new meta repositories for the metarepo project management tool.
- 🦀 **[metarepo-mcp](https://github.com/codyaverett/gestalt)**: Model Context Protocol (MCP) support for the metarepo project management tool.
...
- 🦀 **[metarepo](https://github.com/codyaverett/gestalt)**: A powerful multi-project management tool inspired by the meta npm package - manage multiple git repositories with ease.
- 🦀 **[metarepo-rules](https://github.com/codyaverett/gestalt)**: Validation rules and constraints for the metarepo project management tool.
