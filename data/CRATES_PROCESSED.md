...
- 🦀 **[resource_merger](https://github.com/yourname/resource_merger)**: Merge multiple Minecraft resource packs (directories or zip files/bytes) into a single zip where later packs overwrite earlier ones.
