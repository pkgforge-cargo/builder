...
- 🦀 **[bws-web-server](https://github.com/benliao/bws)**: BWS (Blazing Web Server) - A high-performance multi-site web server built with Pingora.
...
- 🦀 **[edgebert](https://github.com/olafurjohannssson/edgebert)**: Rust + WASM library for BERT inference on native and edge devices with no dependencies.
