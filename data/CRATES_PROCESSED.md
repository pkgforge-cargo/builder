...
- 🦀 **[abk](https://github.com/podtan/abk)**: Agent Builder Kit - Modular utilities for building LLM agents (config, observability, CLI, checkpointing, orchestration).
...
- 🦀 **[rust-rule-engine](https://github.com/KSD-CO/rust-rule-engine)**: A high-performance rule engine for Rust with RETE-UL algorithm (2-24x faster), CLIPS-inspired features (Template System, Defglobal, Deffacts), GRL support, and ~97% Drools compatibility.
