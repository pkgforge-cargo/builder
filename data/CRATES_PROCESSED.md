...
- 🦀 **[lucide](https://github.com/codegress-com/lucide-rs)**: Lucide icon components for Rust UI frameworks (Dioxus, Leptos, Yew, Sycamore).
...
- 🦀 **[ddex-builder](https://github.com/daddykev/ddex-suite)**: Deterministic DDEX XML builder with DB-C14N/1.
- 🦀 **[ddex-parser](https://github.com/daddykev/ddex-suite)**: High-performance DDEX XML parser.
